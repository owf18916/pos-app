        ...
        <div class="bg-white rounded-xl shadow-sm p-4 space-y-3">
            ...
            <div class="flex items-center gap-2">
                <button
                    ...
                    class="bg-red-500 text-white px-4 py-2 text-sm rounded hover:bg-red-600 flex items-center gap-1"
                ...
                <button
                    ...
                    class="bg-blue-600 text-white px-4 py-2 text-sm rounded hover:bg-blue-700 flex items-center gap-1">
                ...
                <button
                    ...
                    class="bg-gray-600 text-white px-4 py-2 text-sm rounded hover:bg-gray-700 flex items-center gap-2">
                    <!-- Icon -->
